...
<div class="row">
                  ...
                  <p class="card-category">The Home Page gallery Setup is done here.</p>
                </div>
                		<div class="card-body">
                      ...
                      <tr><td><img style="max-width: 50px;" src="<?php echo base_url('site_assets/uploads/gallery/'.$ss['gallery_image_name']); ?>"></td><td><?php echo $ss['gallery_image_url']?></td><td><?php echo $ss['gallery_title']?></td><td><?php echo $ss['gallery_subtitle']?></td><td><a onclick="return confirm('Are you sure you want to delete?')" href="<?php echo base_url('admin/gallery_setup/delete/'.$ss['gallery_id']); ?>" class="btn btn-danger">Delete</a></td></tr>
                    <?php endforeach; ?>
                    </tbody>
        					</table>        			
      ...
      <div class="modal-body">
       <div class="col-lg-12">
		...
		<div class="input-group mb-3">
  			...
  			<input  class="form-control" name="gallery_subtitle" id="gallery_subtitle" >
		</div>
       </div>
      </div>
