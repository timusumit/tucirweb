...
<section class="contact">
	...
	<div class="container ">
		...
		<div class="row ">
			<div class="col">
				<article class="staff_details">
					...
					<img src="<?php echo base_url('site_assets/images/hostel.jpg') ?>" class="img-responsive">
					<p class="text-justify">CIR provides accommodation facilities to foreign students/scholars in International Hostel of TU in Kirtipur at modest charge. For accomodation, please, contact:</p>			
				</article>
			</div>
		...
		<div class="row">
			<?php foreach ($hostel_staff as $key=>$data): ?>
